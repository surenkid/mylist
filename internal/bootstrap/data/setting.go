...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "MyList", Type: conf.TypeString, Group: model.SITE},
		{Key: conf.Announcement, Value: "### welcome\nWelcome to my list", Type: conf.TypeText, Group: model.SITE},
		...
		// style settings
		{Key: conf.Logo, Value: "https://img.icons8.com/pulsar-color/420/cloud.png", Type: conf.TypeText, Group: model.STYLE},
		{Key: conf.Favicon, Value: "https://img.icons8.com/pulsar-color/420/cloud.png", Type: conf.TypeString, Group: model.STYLE},
	...
	"epub": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://img.icons8.com/officel/480/cd.png", Type: conf.TypeString, Group: model.PREVIEW},
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.OcrApi, Value: "https://localhost/ocr/file/json", Type: conf.TypeString, Group: model.GLOBAL},
